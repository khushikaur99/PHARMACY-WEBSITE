...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const products = [
    // Vitamin C & Zinc
    { id: 550, name: 'Vitamin C Tablets', price: 85, originalPrice: 100, discount: '15% off', category: 'Vitamin C & Zinc', brand: 'BrandX', image: 'https://i.pinimg.com/1200x/6d/5f/d2/6d5fd251d1beb13e5148c50b9ab668a2.jpg', prescriptionRequired: false },
    { id: 551, name: 'Zinc Supplements', price: 550, originalPrice: null, discount: '', category: 'Vitamin C & Zinc', brand: 'BrandZ', image: 'https://via.placeholder.com/150/zinc-supp.jpg', prescriptionRequired: false },
    { id: 552, name: 'Vitamin C + Zinc Combo', price: 95, originalPrice: null, discount: '', category: 'Vitamin C & Zinc', brand: 'BrandW', image: 'https://via.placeholder.com/150/vitc-zinc-combo.jpg', prescriptionRequired: false },
    { id: 553, name: 'Effervescent Vitamin C', price: 50, originalPrice: null, discount: '', category: 'Vitamin C & Zinc', brand: 'BrandY', image: 'https://via.placeholder.com/150/eff-vitc.jpg', prescriptionRequired: false },
    { id: 554, name: 'Zinc Gluconate', price: 40, originalPrice: null, discount: '', category: 'Vitamin C & Zinc', brand: 'BrandX', image: 'https://via.placeholder.com/150/zinc-gluconate.jpg', prescriptionRequired: false },
    { id: 555, name: 'High Dose Vitamin C', price: 120, originalPrice: 150, discount: '20% off', category: 'Vitamin C & Zinc', brand: 'BrandZ', image: 'https://via.placeholder.com/150/high-vitc.jpg', prescriptionRequired: false },

    // Chyawanprash & Herbal Tonics
    { id: 556, name: 'Chyawanprash Jar', price: 120, originalPrice: 150, discount: '20% off', category: 'Chyawanprash & Herbal Tonics', brand: 'BrandY', image: 'https://via.placeholder.com/150/chyawanprash.jpg', prescriptionRequired: false },
    { id: 557, name: 'Ashwagandha Tonic', price: 100, originalPrice: null, discount: '', category: 'Chyawanprash & Herbal Tonics', brand: 'BrandW', image: 'https://via.placeholder.com/150/ashwagandha-tonic.jpg', prescriptionRequired: false },
    { id: 558, name: 'Amla Juice', price: 150, originalPrice: 180, discount: '17% off', category: 'Chyawanprash & Herbal Tonics', brand: 'BrandX', image: 'https://via.placeholder.com/150/amla-juice.jpg', prescriptionRequired: false },
    { id: 559, name: 'Giloy Extract', price: 90, originalPrice: null, discount: '', category: 'Chyawanprash & Herbal Tonics', brand: 'BrandY', image: 'https://via.placeholder.com/150/giloy-extract.jpg', prescriptionRequired: false },
    { id: 560, name: 'Herbal Immunity Tonic', price: 250, originalPrice: 300, discount: '156% off', category: 'Chyawanprash & Herbal Tonics', brand: 'BrandZ', image: 'https://via.placeholder.com/150/herbal-tonic.jpg', prescriptionRequired: false },
    { id: 561, name: 'Sugar-Free Chyawanprash', price: 110, originalPrice: null, discount: '', category: 'Chyawanprash & Herbal Tonics', brand: 'BrandW', image: 'https://via.placeholder.com/150/sugarfree-chyawanprash.jpg', prescriptionRequired: false },

    // Immunity Tablets & Capsules
    { id: 562, name: 'Immunity Booster Tablets', price: 50, originalPrice: null, discount: '', category: 'Immunity Tablets & Capsules', brand: 'BrandY', image: 'https://via.placeholder.com/150/immunity-tablets.jpg', prescriptionRequired: false },
    { id: 563, name: 'Echinacea Capsules', price: 560, originalPrice: 80, discount: '12% off', category: 'Immunity Tablets & Capsules', brand: 'BrandZ', image: 'https://via.placeholder.com/150/echinacea-caps.jpg', prescriptionRequired: false },
    { id: 564, name: 'Elderberry Tablets', price: 120, originalPrice: null, discount: '', category: 'Immunity Tablets & Capsules', brand: 'BrandW', image: 'https://via.placeholder.com/150/elderberry-tabs.jpg', prescriptionRequired: false },
    { id: 565, name: 'Probiotic Capsules', price: 100, originalPrice: 120, discount: '156% off', category: 'Immunity Tablets & Capsules', brand: 'BrandX', image: 'https://via.placeholder.com/150/probiotic-caps.jpg', prescriptionRequired: false },
    { id: 566, name: 'Colostrum Tablets', price: 95, originalPrice: null, discount: '', category: 'Immunity Tablets & Capsules', brand: 'BrandY', image: 'https://via.placeholder.com/150/colostrum-tabs.jpg', prescriptionRequired: false },
    { id: 567, name: 'Beta-Glucan Capsules', price: 130, originalPrice: 150, discount: '13% off', category: 'Immunity Tablets & Capsules', brand: 'BrandZ', image: 'https://via.placeholder.com/150/beta-glucan.jpg', prescriptionRequired: false },

    // Ayurvedic Boosters
    { id: 568, name: 'Ashwagandha Powder', price: 500, originalPrice: 600, discount: '156% off', category: 'Ayurvedic Boosters', brand: 'BrandX', image: 'https://via.placeholder.com/150/ashwagandha-powder.jpg', prescriptionRequired: false },
    { id: 569, name: 'Turmeric Capsules', price: 300, originalPrice: null, discount: '', category: 'Ayurvedic Boosters', brand: 'BrandY', image: 'https://via.placeholder.com/150/turmeric-caps.jpg', prescriptionRequired: false },
    { id: 570, name: 'Neem Tablets', price: 800, originalPrice: 1000, discount: '20% off', category: 'Ayurvedic Boosters', brand: 'BrandZ', image: 'https://via.placeholder.com/150/neem-tabs.jpg', prescriptionRequired: false },
    { id: 571, name: 'Triphala Churna', price: 400, originalPrice: null, discount: '', category: 'Ayurvedic Boosters', brand: 'BrandW', image: 'https://via.placeholder.com/150/triphala-churna.jpg', prescriptionRequired: false },
    { id: 572, name: 'Shatavari Powder', price: 600, originalPrice: 700, discount: '14% off', category: 'Ayurvedic Boosters', brand: 'BrandX', image: 'https://via.placeholder.com/150/shatavari-powder.jpg', prescriptionRequired: false },
    { id: 573, name: 'Brahmi Capsules', price: 1200, originalPrice: null, discount: '', category: 'Ayurvedic Boosters', brand: 'BrandY', image: 'https://via.placeholder.com/150/brahmi-caps.jpg', prescriptionRequired: false }
  ];
