document.addEventListener('DOMContentLoaded', () => {
  ...
  const products = [
    ...
    { id: 220, name: 'Hydrating Moisturizer', price: 250, originalPrice: 300, discount: '17% off', category: 'Skincare (lotions, creams)', brand: 'BrandX', image: 'https://i.pinimg.com/736x/bb/9c/69/bb9c691524dc7575451ca8c0930692ea.jpg', prescriptionRequired: false },
    { id: 221, name: 'Night Repair Cream', price: 300, originalPrice: null, discount: '', category: 'Skincare (lotions, creams)', brand: 'BrandY', image: 'https://i.pinimg.com/736x/12/34/56/123456789abcdef0123456789abcdef.jpg', prescriptionRequired: false },
    { id: 222, name: 'Vitamin C Serum', price: 350, originalPrice: 400, discount: '13% off', category: 'Skincare (lotions, creams)', brand: 'BrandZ', image: 'https://i.pinimg.com/736x/23/45/67/23456789abcdef0123456789abcdef0.jpg', prescriptionRequired: false },
    { id: 223, name: 'Aloe Vera Gel', price: 150, originalPrice: null, discount: '', category: 'Skincare (lotions, creams)', brand: 'BrandW', image: 'https://i.pinimg.com/736x/34/56/78/3456789abcdef0123456789abcdef01.jpg', prescriptionRequired: false },
    { id: 224, name: 'Retinol Cream', price: 400, originalPrice: 450, discount: '11% off', category: 'Skincare (lotions, creams)', brand: 'BrandX', image: 'https://i.pinimg.com/736x/45/67/89/456789abcdef0123456789abcdef012.jpg', prescriptionRequired: true },
    { id: 225, name: 'Face Moisturizer SPF', price: 280, originalPrice: null, discount: '', category: 'Skincare (lotions, creams)', brand: 'BrandZ', image: 'https://i.pinimg.com/736x/56/78/90/567890abcdef0123456789abcdef0123.jpg', prescriptionRequired: false },

    // Hair Care (shampoos, oils)
    { id: 226, name: 'Anti-Dandruff Shampoo', price: 200, originalPrice: 250, discount: '20% off', category: 'Hair Care (shampoos, oils)', brand: 'BrandY', image: 'https://i.pinimg.com/736x/67/89/ab/6789abcdef0123456789abcdef01234.jpg', prescriptionRequired: false },
    { id: 227, name: 'Argan Oil Hair Serum', price: 300, originalPrice: null, discount: '', category: 'Hair Care (shampoos, oils)', brand: 'BrandW', image: 'https://i.pinimg.com/736x/78/90/bc/7890bcdef0123456789abcdef012345.jpg', prescriptionRequired: false },
    { id: 228, name: 'Herbal Hair Oil', price: 180, originalPrice: 220, discount: '18% off', category: 'Hair Care (shampoos, oils)', brand: 'BrandX', image: 'https://i.pinimg.com/736x/89/ab/cd/89abcdef0123456789abcdef0123456.jpg', prescriptionRequired: false },
    { id: 229, name: 'Volumizing Shampoo', price: 220, originalPrice: null, discount: '', category: 'Hair Care (shampoos, oils)', brand: 'BrandZ', image: 'https://i.pinimg.com/736x/90/bc/de/90bcdef0123456789abcdef01234567.jpg', prescriptionRequired: false },
    { id: 230, name: 'Ketoconazole Shampoo', price: 350, originalPrice: 400, discount: '13% off', category: 'Hair Care (shampoos, oils)', brand: 'BrandY', image: 'https://i.pinimg.com/736x/ab/cd/ef/abcdef0123456789abcdef012345678.jpg', prescriptionRequired: true },
    { id: 231, name: 'Coconut Oil Hair Mask', price: 150, originalPrice: null, discount: '', category: 'Hair Care (shampoos, oils)', brand: 'BrandW', image: 'https://i.pinimg.com/736x/bc/de/f0/bcdef0123456789abcdef0123456789.jpg', prescriptionRequired: false },

    // Acne & Pimples Care
    { id: 232, name: 'Benzoyl Peroxide Gel', price: 200, originalPrice: 240, discount: '17% off', category: 'Acne & Pimples Care', brand: 'BrandX', image: 'https://i.pinimg.com/736x/cd/ef/01/cdef0123456789abcdef0123456789a.jpg', prescriptionRequired: true },
    { id: 233, name: 'Salicylic Acid Cleanser', price: 180, originalPrice: null, discount: '', category: 'Acne & Pimples Care', brand: 'BrandZ', image: 'https://i.pinimg.com/736x/de/f0/12/def0123456789abcdef0123456789ab.jpg', prescriptionRequired: false },
    { id: 234, name: 'Acne Spot Treatment', price: 150, originalPrice: 180, discount: '17% off', category: 'Acne & Pimples Care', brand: 'BrandY', image: 'https://i.pinimg.com/736x/ef/01/23/ef0123456789abcdef0123456789abc.jpg', prescriptionRequired: false },
    { id: 235, name: 'Tea Tree Oil Serum', price: 220, originalPrice: null, discount: '', category: 'Acne & Pimples Care', brand: 'BrandW', image: 'https://i.pinimg.com/736x/f0/12/34/f0123456789abcdef0123456789abcd.jpg', prescriptionRequired: false },
    { id: 236, name: 'Clindamycin Gel', price: 250, originalPrice: 300, discount: '17% off', category: 'Acne & Pimples Care', brand: 'BrandX', image: 'https://i.pinimg.com/736x/01/23/45/0123456789abcdef0123456789abcde.jpg', prescriptionRequired: true },
    { id: 237, name: 'Acne Face Wash', price: 170, originalPrice: null, discount: '', category: 'Acne & Pimples Care', brand: 'BrandZ', image: 'https://i.pinimg.com/736x/12/34/56/123456789abcdef0123456789abcdef.jpg', prescriptionRequired: false },

    // Sunscreens
    { id: 238, name: 'SPF 50 Sunscreen Lotion', price: 300, originalPrice: 350, discount: '14% off', category: 'Sunscreens', brand: 'BrandY', image: 'https://i.pinimg.com/736x/23/45/67/23456789abcdef0123456789abcdef0.jpg', prescriptionRequired: false },
    { id: 239, name: 'SPF 30 Gel Sunscreen', price: 250, originalPrice: null, discount: '', category: 'Sunscreens', brand: 'BrandW', image: 'https://i.pinimg.com/736x/34/56/78/3456789abcdef0123456789abcdef01.jpg', prescriptionRequired: false },
    { id: 240, name: 'Tinted Sunscreen SPF 40', price: 320, originalPrice: 380, discount: '16% off', category: 'Sunscreens', brand: 'BrandX', image: 'https://i.pinimg.com/736x/45/67/89/456789abcdef0123456789abcdef012.jpg', prescriptionRequired: false },
    { id: 241, name: 'Broad Spectrum SPF 50', price: 280, originalPrice: null, discount: '', category: 'Sunscreens', brand: 'BrandZ', image: 'https://i.pinimg.com/736x/56/78/90/567890abcdef0123456789abcdef0123.jpg', prescriptionRequired: false },
    { id: 242, name: 'Sunscreen Spray SPF 30', price: 270, originalPrice: 320, discount: '16% off', category: 'Sunscreens', brand: 'BrandY', image: 'https://i.pinimg.com/736x/67/89/ab/6789abcdef0123456789abcdef01234.jpg', prescriptionRequired: false },
    { id: 243, name: 'Kids Sunscreen SPF 50', price: 260, originalPrice: null, discount: '', category: 'Sunscreens', brand: 'BrandW', image: 'https://i.pinimg.com/736x/78/90/bc/7890bcdef0123456789abcdef012345.jpg', prescriptionRequired: false },

    // Anti-Ageing
    { id: 244, name: 'Retinol Serum', price: 400, originalPrice: 450, discount: '11% off', category: 'Anti-Ageing', brand: 'BrandX', image: 'https://i.pinimg.com/736x/89/ab/cd/89abcdef0123456789abcdef0123456.jpg', prescriptionRequired: false },
    { id: 245, name: 'Hyaluronic Acid Cream', price: 350, originalPrice: null, discount: '', category: 'Anti-Ageing', brand: 'BrandZ', image: 'https://i.pinimg.com/736x/90/bc/de/90bcdef0123456789abcdef01234567.jpg', prescriptionRequired: false },
    { id: 246, name: 'Collagen Booster Capsules', price: 300, originalPrice: 360, discount: '17% off', category: 'Anti-Ageing', brand: 'BrandY', image: 'https://i.pinimg.com/736x/ab/cd/ef/abcdef0123456789abcdef012345678.jpg', prescriptionRequired: false },
    { id: 247, name: 'Anti-Wrinkle Cream', price: 380, originalPrice: null, discount: '', category: 'Anti-Ageing', brand: 'BrandW', image: 'https://i.pinimg.com/736x/bc/de/f0/bcdef0123456789abcdef0123456789.jpg', prescriptionRequired: false },
    { id: 248, name: 'Vitamin C Anti-Ageing Serum', price: 420, originalPrice: 480, discount: '13% off', category: 'Anti-Ageing', brand: 'BrandX', image: 'https://i.pinimg.com/736x/cd/ef/01/cdef0123456789abcdef0123456789a.jpg', prescriptionRequired: false },
    { id: 249, name: 'Prescription Anti-Ageing Cream', price: 500, originalPrice: null, discount: '', category: 'Anti-Ageing', brand: 'BrandZ', image: 'https://i.pinimg.com/736x/de/f0/12/def0123456789abcdef0123456789ab.jpg', prescriptionRequired: true },

    // RX
    { id: 250, name: 'Prescription Acne Cream', price: 300, originalPrice: 350, discount: '14% off', category: 'Acne & Pimples Care', brand: 'BrandX', image: 'https://i.pinimg.com/736x/ef/01/23/ef0123456789abcdef0123456789abc.jpg', prescriptionRequired: true },
    { id: 251, name: 'Prescription Hair Growth Solution', price: 400, originalPrice: null, discount: '', category: 'Hair Care (shampoos, oils)', brand: 'BrandZ', image: 'https://i.pinimg.com/736x/f0/12/34/f0123456789abcdef0123456789abcd.jpg', prescriptionRequired: true }
  ];
